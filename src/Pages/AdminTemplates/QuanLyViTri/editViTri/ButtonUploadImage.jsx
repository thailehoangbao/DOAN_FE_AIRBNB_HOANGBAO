...
import { actFetchUploadImgViTri } from './duckUploadImgViTri/actUploadImgVitri';

export default function ButtonUploadImage({vitri_id}) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (value) => {
            ...
            dispatch(actFetchUploadImgViTri(vitri_id,formData, navigate));
        }
    });
