      ...
      <div className='grid grid-cols-2 w-full'>
        ...
        <div>
          <Form.Item label="Mật Khẩu" style={{ fontSize: "1.2rem" }} >
            <Input.Password name="pass_word" type='password' className='rounded-md p-1' style={{ height: "30px" }} onChange={formik.handleChange} value={formik.values.password} iconRender={visible => (visible ? <EyeTwoTone /> : <EyeInvisibleOutlined />)}/>
          </Form.Item>
