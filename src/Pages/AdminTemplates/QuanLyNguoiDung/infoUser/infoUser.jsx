            ...
            <div className='grid grid-cols-2 w-full'>
                ...
                <div>
                    <Form.Item label="Mật Khẩu" style={{ fontSize: "1.2rem" }} >
                        <Input disabled name="pass_word" type='password' className='rounded-md p-1' style={{ height: "30px" }} onChange={formik.handleChange} value={info?.pass_word} />
                    </Form.Item>
                    <Form.Item label="Birthday" style={{ fontSize: "1.2rem" }} >
                        <Input disabled name="birth_day" type='text' className='rounded-md p-1' style={{ height: "30px" }} onChange={formik.handleChange} value={info?.birth_day} />
                    </Form.Item>
