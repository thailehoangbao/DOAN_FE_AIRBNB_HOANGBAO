...
export default function DetailPage() {
    ...
    if (!JSON.parse(localStorage.getItem(USER_LOGIN))?.token) {
        ...
        <div className='p-20 detail-layout'>
            <div>
                <p>
                    ...
                    <span className="font-semibold text-xl sm:text-3xl tracking-widest leading-relaxed text-gray-900">{data?.ten_phong}</span>
                </p>
                <div className="flex flex-wrap justify-between items-center">
                    <div>
                        ...
                        <span className="underline text-sm font-normal tracking-widest mx-1">{vitri?.ten_vi_tri}, {vitri?.tinh_thanh}, {vitri?.quoc_gia}</span>
                    </div>
            ...
            <div className="w-full flex sm:flex-row flex-col mt-10 border-b pb-5">
                <div className="w-full sm:w-1/2 lg:w-3/5">
                    <div className="flex flex-wrap justify-between items-center pb-5 border-b">
                        <div>
                            ...
                            <span className="text-sm font-normal  tracking-widest text-gray-700">
                                ...
                                <span className=" mx-1">{data?.phong_ngu} phòng ngủ . </span>
                                <span className=" mx-1">{data?.phong_tam} phòng tắm . </span>
                            </span>
                        </div>
                    ...
                    <div className="mt-5 pb-5 border-b">
                        ...
                        <p className="text-base tracking-wider text-gray-800 mb-4">{data?.mo_ta}...</p>
                    ...
                    <div className="mt-5 pb-5">
                        ...
                        <div className="grid grid-cols-2">
                            ...
                            <div className="flex items-center pb-4">
                                ...
                                <div className="ml-4 text-base tracking-wider text-gray-800">{data?.wi_fi ? 'Wifi' : 'Không Có Wifi'}</div>
                            </div>
                            <div className="flex items-center pb-4">
                                <div>
                                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}>
                                ...
                                <div className="ml-4 text-base tracking-wider text-gray-800">{data?.than_may ? 'Thang Máy' : 'Không Có Thang Máy'}</div>
                            </div>
                            <div className="flex items-center pb-4">
                                <div>
                                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}>
                            ...
                            <div className="flex items-center pb-4">
                                ...
                                <div className="ml-4 text-base tracking-wider text-gray-800">{data?.dieu_hoa ? 'Điều Hòa' : 'Không Có Điều Hòa'}</div>
                            </div>
                            <div className="flex items-center pb-4">
                                <div>
                                    <i className="fa-solid fa-person-swimming" />
                                </div>
                                <div className="ml-4 text-base tracking-wider text-gray-800">{data?.ho_boi ? 'Hồ Bơi' : 'Không Có Hồ Bơi'}</div>
                            </div>
                            <div>
                                <div className="flex items-center pb-4">
                                    <div>
                                    ...
                                    <div className="ml-4 text-base tracking-wider text-gray-800">{data?.do_xe ? 'Bãi Đậu Xe' : 'Không Bãi Đậu Xe'}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <PopupDatPhong gia_tien={data?.gia_tien} />
            </div>
            <div className='mt-20'>
